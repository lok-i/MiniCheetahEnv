...
CHASSIS_NAME_PATTERN = re.compile(r"torso_to_abduct_\w+_j")
MOTOR_NAME_PATTERN = re.compile(r"abduct_\w+_to_thigh_\w+_j")
KNEE_NAME_PATTERN = re.compile(r"thigh_\w+_to_knee_\w+_j")
TOE_NAME_PATTERN = re.compile(r"toe_\d*")
...
class SimpleRobot(object):
  def __init__(self, pybullet_client, robot_uid, simulation_time_step):
    ...
    self._motor_offset= np.zeros(12)
